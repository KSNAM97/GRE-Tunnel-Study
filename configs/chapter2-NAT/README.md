# 📁 Chapter 2. NAT Overload (PAT) 구성

SOL-A, SOL-B의 내부 네트워크가 외부 통신 시 **공인 IP(Serial 인터페이스 IP)**로 변환되도록 PAT를 구성합니다.

## 🎯 조건

- SOL-A : 192.168.10.0/24 → Serial1/0.10 IP 하나로 변환
- SOL-B : 192.168.20.0/24 → Serial1/0.20 IP 하나로 변환
