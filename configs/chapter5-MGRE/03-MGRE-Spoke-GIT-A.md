# Chapter 5-3. MGRE Spoke (NHRP Client) - GIT-A (R5)

지사 A를 **MGRE Spoke** + **NHRP Client**로 구성합니다.
...
| Tunnel Source | 211.241.25.2 (F0/0) |
...
```bash
GIT-A# show ip nhrp brief
Target          Via          NBMA          Mode    Intfc   Claimed
172.16.100.1/32 172.16.100.1 211.241.14.1  static  Tu123   < >

GIT-A# ping 172.16.100.1
GIT-A# ping 172.16.100.3   ! Spoke ↔ Spoke 통신
```
